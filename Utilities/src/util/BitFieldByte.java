...
public class BitFieldByte {
	...
	private byte[] arr;
	private static final int SIZE_MINUS_ONE = Byte.SIZE - 1;
	private static final int SIZE = Byte.SIZE;
	private int capacity = 0;
	public Resizer resizer = Resizer.DOUBLE_RESIZE;

	public BitFieldByte(int capacity) {
		arr = new byte[(capacity + SIZE_MINUS_ONE) / SIZE];
	}
