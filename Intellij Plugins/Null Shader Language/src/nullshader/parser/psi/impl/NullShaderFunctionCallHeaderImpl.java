...
public class NullShaderFunctionCallHeaderImpl extends ASTWrapperPsiElement implements NullShaderFunctionCallHeader {

  public NullShaderFunctionCallHeaderImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitFunctionCallHeader(this);
  }
