...
public class NullShaderParameterDeclaratorImpl extends ASTWrapperPsiElement implements NullShaderParameterDeclarator {

  public NullShaderParameterDeclaratorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitParameterDeclarator(this);
  }
