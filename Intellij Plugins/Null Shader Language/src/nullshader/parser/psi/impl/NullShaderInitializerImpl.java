...
public class NullShaderInitializerImpl extends ASTWrapperPsiElement implements NullShaderInitializer {

  public NullShaderInitializerImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public NullShaderInitializerList getInitializerList() {
    return findChildByClass(NullShaderInitializerList.class);
  }
