...
public class NullShaderPIfdefImpl extends ASTWrapperPsiElement implements NullShaderPIfdef {

  public NullShaderPIfdefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPIfdef(this);
  }
