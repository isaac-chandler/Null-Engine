...
public class NullShaderForRestStatementImpl extends ASTWrapperPsiElement implements NullShaderForRestStatement {

  public NullShaderForRestStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitForRestStatement(this);
  }
  ...
  @Override
  @NotNull
  public NullShaderConditionopt getConditionopt() {
    return findNotNullChildByClass(NullShaderConditionopt.class);
  }
