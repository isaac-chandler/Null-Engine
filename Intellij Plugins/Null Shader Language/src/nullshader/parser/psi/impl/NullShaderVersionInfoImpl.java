...
public class NullShaderVersionInfoImpl extends ASTWrapperPsiElement implements NullShaderVersionInfo {

  public NullShaderVersionInfoImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitVersionInfo(this);
  }
