...
public class NullShaderInterpolationQualifierImpl extends ASTWrapperPsiElement implements NullShaderInterpolationQualifier {

  public NullShaderInterpolationQualifierImpl(ASTNode node) {
    super(node);
  }
