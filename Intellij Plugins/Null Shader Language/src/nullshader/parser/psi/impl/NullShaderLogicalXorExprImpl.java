...
public class NullShaderLogicalXorExprImpl extends NullShaderExprImpl implements NullShaderLogicalXorExpr {

  public NullShaderLogicalXorExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitLogicalXorExpr(this);
  }
