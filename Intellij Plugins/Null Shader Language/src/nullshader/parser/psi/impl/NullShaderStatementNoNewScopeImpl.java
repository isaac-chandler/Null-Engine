...
public class NullShaderStatementNoNewScopeImpl extends ASTWrapperPsiElement implements NullShaderStatementNoNewScope {

  public NullShaderStatementNoNewScopeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitStatementNoNewScope(this);
  }
  ...
  public NullShaderCompoundStatementNoNewScope getCompoundStatementNoNewScope() {
    return findChildByClass(NullShaderCompoundStatementNoNewScope.class);
  }
