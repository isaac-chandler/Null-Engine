...
public class NullShaderPIncludeImpl extends ASTWrapperPsiElement implements NullShaderPInclude {

  public NullShaderPIncludeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPInclude(this);
  }
