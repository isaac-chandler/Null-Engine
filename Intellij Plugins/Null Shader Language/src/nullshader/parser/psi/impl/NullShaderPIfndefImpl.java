...
public class NullShaderPIfndefImpl extends ASTWrapperPsiElement implements NullShaderPIfndef {

  public NullShaderPIfndefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPIfndef(this);
  }
