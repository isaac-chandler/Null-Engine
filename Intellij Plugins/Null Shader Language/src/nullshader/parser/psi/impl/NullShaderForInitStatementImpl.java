...
public class NullShaderForInitStatementImpl extends ASTWrapperPsiElement implements NullShaderForInitStatement {

  public NullShaderForInitStatementImpl(ASTNode node) {
    super(node);
  }
