...
public class NullShaderAddExprImpl extends NullShaderExprImpl implements NullShaderAddExpr {

  public NullShaderAddExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NullShaderAddOp getAddOp() {
    return findNotNullChildByClass(NullShaderAddOp.class);
  }
