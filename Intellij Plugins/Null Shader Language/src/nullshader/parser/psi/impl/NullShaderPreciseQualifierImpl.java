...
public class NullShaderPreciseQualifierImpl extends ASTWrapperPsiElement implements NullShaderPreciseQualifier {

  public NullShaderPreciseQualifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPreciseQualifier(this);
  }
