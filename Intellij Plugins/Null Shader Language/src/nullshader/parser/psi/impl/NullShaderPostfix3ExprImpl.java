...
public class NullShaderPostfix3ExprImpl extends NullShaderExprImpl implements NullShaderPostfix3Expr {

  public NullShaderPostfix3ExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPostfix3Expr(this);
  }
  ...
  @Override
  @NotNull
  public NullShaderFieldSelection getFieldSelection() {
    return findNotNullChildByClass(NullShaderFieldSelection.class);
  }
