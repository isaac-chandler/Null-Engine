...
public class NullShaderIdentifierListImpl extends ASTWrapperPsiElement implements NullShaderIdentifierList {

  public NullShaderIdentifierListImpl(ASTNode node) {
    super(node);
  }
