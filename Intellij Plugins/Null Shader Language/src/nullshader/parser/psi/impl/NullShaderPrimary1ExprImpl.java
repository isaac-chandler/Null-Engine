...
public class NullShaderPrimary1ExprImpl extends NullShaderExprImpl implements NullShaderPrimary1Expr {

  public NullShaderPrimary1ExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPrimary1Expr(this);
  }
