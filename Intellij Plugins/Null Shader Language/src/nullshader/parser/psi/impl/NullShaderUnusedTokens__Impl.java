...
public class NullShaderUnusedTokens__Impl extends ASTWrapperPsiElement implements NullShaderUnusedTokens__ {

  public NullShaderUnusedTokens__Impl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitUnusedTokens__(this);
  }
