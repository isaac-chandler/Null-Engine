...
public class NullShaderLayoutQualiferIdImpl extends ASTWrapperPsiElement implements NullShaderLayoutQualiferId {

  public NullShaderLayoutQualiferIdImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitLayoutQualiferId(this);
  }
