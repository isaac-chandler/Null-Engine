...
public class NullShaderConditionoptImpl extends ASTWrapperPsiElement implements NullShaderConditionopt {

  public NullShaderConditionoptImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitConditionopt(this);
  }
  ...
  public NullShaderCondition getCondition() {
    return findNotNullChildByClass(NullShaderCondition.class);
  }
