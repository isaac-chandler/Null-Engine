...
public class NullShaderPostfix6ExprImpl extends NullShaderExprImpl implements NullShaderPostfix6Expr {

  public NullShaderPostfix6ExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPostfix6Expr(this);
  }
