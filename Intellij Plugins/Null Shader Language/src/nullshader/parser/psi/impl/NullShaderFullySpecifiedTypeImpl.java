...
public class NullShaderFullySpecifiedTypeImpl extends ASTWrapperPsiElement implements NullShaderFullySpecifiedType {

  public NullShaderFullySpecifiedTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitFullySpecifiedType(this);
  }
