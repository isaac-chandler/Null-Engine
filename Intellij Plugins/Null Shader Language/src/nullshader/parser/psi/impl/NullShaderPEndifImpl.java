...
public class NullShaderPEndifImpl extends ASTWrapperPsiElement implements NullShaderPEndif {

  public NullShaderPEndifImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPEndif(this);
  }
