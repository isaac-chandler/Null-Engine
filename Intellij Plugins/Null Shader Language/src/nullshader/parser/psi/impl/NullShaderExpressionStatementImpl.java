...
public class NullShaderExpressionStatementImpl extends ASTWrapperPsiElement implements NullShaderExpressionStatement {

  public NullShaderExpressionStatementImpl(ASTNode node) {
    super(node);
  }
