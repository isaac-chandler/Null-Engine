...
public class NullShaderSelectionStatementImpl extends ASTWrapperPsiElement implements NullShaderSelectionStatement {

  public NullShaderSelectionStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NullShaderSelectionRestStatement getSelectionRestStatement() {
    return findNotNullChildByClass(NullShaderSelectionRestStatement.class);
  }
