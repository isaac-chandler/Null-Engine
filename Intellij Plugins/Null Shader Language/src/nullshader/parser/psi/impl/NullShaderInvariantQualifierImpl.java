...
public class NullShaderInvariantQualifierImpl extends ASTWrapperPsiElement implements NullShaderInvariantQualifier {

  public NullShaderInvariantQualifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitInvariantQualifier(this);
  }
