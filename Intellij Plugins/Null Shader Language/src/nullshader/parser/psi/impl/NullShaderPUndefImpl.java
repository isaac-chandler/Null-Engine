...
public class NullShaderPUndefImpl extends ASTWrapperPsiElement implements NullShaderPUndef {

  public NullShaderPUndefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPUndef(this);
  }
