...
public class NullShaderUnaryOperatorImpl extends ASTWrapperPsiElement implements NullShaderUnaryOperator {

  public NullShaderUnaryOperatorImpl(ASTNode node) {
    super(node);
  }
