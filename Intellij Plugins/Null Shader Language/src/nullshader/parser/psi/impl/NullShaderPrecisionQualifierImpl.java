...
public class NullShaderPrecisionQualifierImpl extends ASTWrapperPsiElement implements NullShaderPrecisionQualifier {

  public NullShaderPrecisionQualifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPrecisionQualifier(this);
  }
