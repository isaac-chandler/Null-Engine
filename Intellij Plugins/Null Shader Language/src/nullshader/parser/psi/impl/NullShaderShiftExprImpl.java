...
public class NullShaderShiftExprImpl extends NullShaderExprImpl implements NullShaderShiftExpr {

  public NullShaderShiftExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NullShaderShiftOp getShiftOp() {
    return findNotNullChildByClass(NullShaderShiftOp.class);
  }
