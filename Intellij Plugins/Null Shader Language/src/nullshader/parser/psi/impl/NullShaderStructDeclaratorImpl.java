...
public class NullShaderStructDeclaratorImpl extends ASTWrapperPsiElement implements NullShaderStructDeclarator {

  public NullShaderStructDeclaratorImpl(ASTNode node) {
    super(node);
  }
