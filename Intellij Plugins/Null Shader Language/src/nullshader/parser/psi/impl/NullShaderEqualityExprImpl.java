...
public class NullShaderEqualityExprImpl extends NullShaderExprImpl implements NullShaderEqualityExpr {

  public NullShaderEqualityExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NullShaderEqualityOp getEqualityOp() {
    return findNotNullChildByClass(NullShaderEqualityOp.class);
  }
