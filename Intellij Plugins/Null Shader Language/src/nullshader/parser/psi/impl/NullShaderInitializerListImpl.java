...
public class NullShaderInitializerListImpl extends ASTWrapperPsiElement implements NullShaderInitializerList {

  public NullShaderInitializerListImpl(ASTNode node) {
    super(node);
  }
