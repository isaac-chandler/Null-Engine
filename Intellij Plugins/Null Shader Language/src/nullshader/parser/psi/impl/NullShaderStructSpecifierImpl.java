...
public class NullShaderStructSpecifierImpl extends ASTWrapperPsiElement implements NullShaderStructSpecifier {

  public NullShaderStructSpecifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitStructSpecifier(this);
  }
  ...
  public NullShaderStructDeclarationList getStructDeclarationList() {
    return findNotNullChildByClass(NullShaderStructDeclarationList.class);
  }
