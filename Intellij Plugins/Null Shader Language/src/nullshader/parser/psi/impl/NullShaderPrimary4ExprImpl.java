...
public class NullShaderPrimary4ExprImpl extends NullShaderExprImpl implements NullShaderPrimary4Expr {

  public NullShaderPrimary4ExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPrimary4Expr(this);
  }
