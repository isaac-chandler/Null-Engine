...
public class NullShaderPElseImpl extends ASTWrapperPsiElement implements NullShaderPElse {

  public NullShaderPElseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPElse(this);
  }
