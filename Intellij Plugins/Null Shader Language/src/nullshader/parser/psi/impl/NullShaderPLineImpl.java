...
public class NullShaderPLineImpl extends ASTWrapperPsiElement implements NullShaderPLine {

  public NullShaderPLineImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPLine(this);
  }
