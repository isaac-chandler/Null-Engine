...
public class NullShaderMulExprImpl extends NullShaderExprImpl implements NullShaderMulExpr {

  public NullShaderMulExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NullShaderMulOp getMulOp() {
    return findNotNullChildByClass(NullShaderMulOp.class);
  }
