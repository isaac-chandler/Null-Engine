...
public class NullShaderPDefineImpl extends ASTWrapperPsiElement implements NullShaderPDefine {

  public NullShaderPDefineImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPDefine(this);
  }
