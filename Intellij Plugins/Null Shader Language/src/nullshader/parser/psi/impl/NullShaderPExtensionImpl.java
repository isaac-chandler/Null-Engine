...
public class NullShaderPExtensionImpl extends ASTWrapperPsiElement implements NullShaderPExtension {

  public NullShaderPExtensionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPExtension(this);
  }
