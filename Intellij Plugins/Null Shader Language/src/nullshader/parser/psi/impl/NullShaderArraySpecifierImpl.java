...
public class NullShaderArraySpecifierImpl extends ASTWrapperPsiElement implements NullShaderArraySpecifier {

  public NullShaderArraySpecifierImpl(ASTNode node) {
    super(node);
  }
