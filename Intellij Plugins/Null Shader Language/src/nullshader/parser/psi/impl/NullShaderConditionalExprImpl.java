...
public class NullShaderConditionalExprImpl extends NullShaderExprImpl implements NullShaderConditionalExpr {

  public NullShaderConditionalExprImpl(ASTNode node) {
    super(node);
  }
