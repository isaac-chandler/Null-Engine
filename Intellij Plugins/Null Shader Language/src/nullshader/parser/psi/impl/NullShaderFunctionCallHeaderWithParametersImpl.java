...
public class NullShaderFunctionCallHeaderWithParametersImpl extends ASTWrapperPsiElement implements NullShaderFunctionCallHeaderWithParameters {

  public NullShaderFunctionCallHeaderWithParametersImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitFunctionCallHeaderWithParameters(this);
  }
