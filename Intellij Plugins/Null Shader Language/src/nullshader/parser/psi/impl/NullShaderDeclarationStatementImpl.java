...
public class NullShaderDeclarationStatementImpl extends ASTWrapperPsiElement implements NullShaderDeclarationStatement {

  public NullShaderDeclarationStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public NullShaderDeclaration getDeclaration() {
    return findNotNullChildByClass(NullShaderDeclaration.class);
  }
