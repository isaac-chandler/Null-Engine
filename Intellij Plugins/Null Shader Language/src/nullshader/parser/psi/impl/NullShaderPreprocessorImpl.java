...
public class NullShaderPreprocessorImpl extends ASTWrapperPsiElement implements NullShaderPreprocessor {

  public NullShaderPreprocessorImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NullShaderPBody getPBody() {
    return findNotNullChildByClass(NullShaderPBody.class);
  }
