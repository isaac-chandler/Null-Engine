...
public class NullShaderParameterTypeSpecifierImpl extends ASTWrapperPsiElement implements NullShaderParameterTypeSpecifier {

  public NullShaderParameterTypeSpecifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitParameterTypeSpecifier(this);
  }
