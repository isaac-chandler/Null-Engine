...
public class NullShaderJumpStatementImpl extends ASTWrapperPsiElement implements NullShaderJumpStatement {

  public NullShaderJumpStatementImpl(ASTNode node) {
    super(node);
  }
