...
public class NullShaderTypeSpecifierImpl extends ASTWrapperPsiElement implements NullShaderTypeSpecifier {

  public NullShaderTypeSpecifierImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NullShaderTypeSpecifierNonArray getTypeSpecifierNonArray() {
    return findNotNullChildByClass(NullShaderTypeSpecifierNonArray.class);
  }
