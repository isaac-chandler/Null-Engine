...
public class NullShaderPostfix1ExprImpl extends NullShaderExprImpl implements NullShaderPostfix1Expr {

  public NullShaderPostfix1ExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPostfix1Expr(this);
  }
