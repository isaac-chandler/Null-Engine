...
public class NullShaderPrimary3ExprImpl extends NullShaderExprImpl implements NullShaderPrimary3Expr {

  public NullShaderPrimary3ExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPrimary3Expr(this);
  }
