...
public class NullShaderConditionImpl extends ASTWrapperPsiElement implements NullShaderCondition {

  public NullShaderConditionImpl(ASTNode node) {
    super(node);
  }
  ...
  public NullShaderFullySpecifiedType getFullySpecifiedType() {
    return findChildByClass(NullShaderFullySpecifiedType.class);
  }
