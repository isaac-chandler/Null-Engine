...
public class NullShaderPrimary7ExprImpl extends NullShaderExprImpl implements NullShaderPrimary7Expr {

  public NullShaderPrimary7ExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NullShaderVisitor visitor) {
    visitor.visitPrimary7Expr(this);
  }
