...
public class AddProfileIntention extends BaseElementAtCaretIntentionAction {

	private PsiElement info;
	private String newProfile;


	public AddProfileIntention(PsiElement info, String newProfile) {
		this.info = info;
	...
	public void invoke(@NotNull final Project project, final Editor editor, @NotNull PsiElement element) throws IncorrectOperationException {
		new WriteCommandAction(project, element.getContainingFile()){
			...
			protected void run(@NotNull Result result) throws Throwable {
				editor.getDocument().insertString(info.getTextRange().getEndOffset(), " " + newProfile);
			}
		}.execute();
	}
