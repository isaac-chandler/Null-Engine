...
public class ClearScreenDemo {
	...
	private static ByteBuffer[] layers = {
			memEncodeUTF8("VK_LAYER_LUNARG_standard_validation"),
	};
	...
	private static VkInstance createInstance(PointerBuffer requiredExtensions) {
		...
		VkApplicationInfo appInfo = VkApplicationInfo.calloc()
				...
				.pApplicationName(memEncodeUTF8("GLFW Vulkan Demo"))
				.pEngineName(memEncodeUTF8(""))
		...
		ByteBuffer VK_EXT_DEBUG_REPORT_EXTENSION = memEncodeUTF8(VK_EXT_DEBUG_REPORT_EXTENSION_NAME);
	...
	private static DeviceAndGraphicsQueueFamily createDeviceAndGetGraphicsQueueFamily(VkPhysicalDevice physicalDevice) {
		...
		ByteBuffer VK_KHR_SWAPCHAIN_EXTENSION = memEncodeUTF8(VK_KHR_SWAPCHAIN_EXTENSION_NAME);
